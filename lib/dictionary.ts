...
const en: Dict = {
  ...
  langSwitch: { label: "عربي", aria: "Switch to Arabic" },
  header: {
    primaryAria: "Primary",
    mobileAria: "Mobile",
...
const ar: Dict = {
  brand: { line1: "الشهيل", line2: "للصناعات الغذائية" },
  ...
  home: {
    ...
    about: {
      ...
      description:
        "الشهيل للصناعات الغذائية مصنّع مخبوزات مقره الإمارات، متخصص في المخبوزات الحديثة وإنتاج العلامة الخاصة وتطوير المنتجات لأسواق التجزئة والمؤسسات.",
      cta: "تعرّف على الشهيل",
    },
    services: {
      eyebrow: "أبعد من التصنيع",
      title: "شريك واحد عبر رحلة المنتج الغذائي",
      description:
        "يدعم الشهيل العلامات الغذائية عبر الإنتاج والتغليف والتوزيع والتواصل الرقمي — لينتقل المنتج من الفكرة إلى تنفيذ جاهز للتجزئة.",
      items: [
        {
    ...
    finalCta: {
      ...
      description:
        "تحدّث إلى الشهيل حول دعم التصنيع والتغليف والتوزيع والتواصل حول المنتج لعلامتك الغذائية.",
      primary: "ابدأ مشروعك",
