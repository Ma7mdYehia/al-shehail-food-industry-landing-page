...
const copy = {
  ...
  ar: {
    ...
    heroSubtitle:
      "يدعم الشهيل للصناعات الغذائية العلامات الغذائية وتوريد التجزئة عبر التصنيع بعلامة خاصة وتطوير المنتجات والإنتاج المهيأ للسوق.",
    ...
    trustDesc:
      "الوصول إلى بيئات التجزئة الكبرى والبقاء فيها يتطلب ثباتًا وجاهزية تغليف وجودة موثوقة وانضباطًا تشغيليًا في كل دفعة. وهذا هو المعيار الذي يصنّع الشهيل وفقه.",
    ctaEyebrow: "اعمل معنا شريكًا",
    ctaTitle: "صنّع علامة مخبوزاتك مع الشهيل",
    ctaText:
