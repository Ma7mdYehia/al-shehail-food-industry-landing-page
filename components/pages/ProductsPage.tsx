      ...
      <main>
        ...
        <section className="relative overflow-hidden pt-32 pb-14 sm:pt-36 lg:pt-44 lg:pb-16">
          <div className="pointer-events-none absolute inset-0 -z-10">
            <Image
              src={generatedAssets.pageHeaders.products}
              alt=""
              fill
              priority
              sizes="100vw"
              ...
              aria-hidden
            />
            <div className="absolute inset-0 bg-gradient-to-r from-warmwhite/95 via-cream/85 to-cream/45 rtl:bg-gradient-to-l" />
