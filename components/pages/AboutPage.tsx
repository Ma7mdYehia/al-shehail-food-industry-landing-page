...
const copy = {
  ...
  ar: {
    heroEyebrow: "عن الشحيل",
    heroTitle: "شريك تصنيع مخبوزات مقره الإمارات",
    heroSubtitle:
      "الشحيل للصناعات الغذائية شركة تصنيع مخبوزات مقرها الإمارات، متخصصة في المخبوزات الحديثة وإنتاج العلامة الخاصة وتطوير المنتجات لأسواق التجزئة والمؤسسات.",
    explorePl: "استكشف العلامة الخاصة",
    contactUs: "تواصل معنا",
    whoEyebrow: "من نحن",
    whoTitle: "مصنّع مخبوزات مبني حول العلامات التجارية",
    whoDesc:
      "الشحيل للصناعات الغذائية مصنّع مخبوزات مقره الإمارات بتوجه إنتاج حديث يميل إلى الصحة. نجمع بين تطوير المنتجات والتصنيع ودعم العلامة الخاصة تحت شريك واحد — لخدمة أسواق التجزئة والمؤسسات.",
    whoCards: [
