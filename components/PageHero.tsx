...
export default function PageHero({ eyebrow, title, subtitle, children, backgroundImage }: Props) {
  return (
    <section className="relative overflow-hidden pt-32 pb-12 sm:pt-36 lg:pt-44 lg:pb-16">
      <div className="pointer-events-none absolute inset-0 -z-10">
        ...
        <div
          className={
            backgroundImage
              ? "absolute inset-0 bg-gradient-to-r from-warmwhite/95 via-cream/85 to-cream/45 rtl:bg-gradient-to-l"
              : "absolute inset-0 bg-gradient-to-b from-warmwhite via-cream to-beige/40"
          }
        />
        {backgroundImage && (
